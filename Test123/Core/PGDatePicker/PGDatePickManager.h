...
@property (nonatomic, weak) PGDatePickerManagerCustomHeaderView *headerView;
...
/**
 custom
 */
@property (nonatomic, copy)  void(^finishButtonMonitor)(NSString *startTime,NSString *endTime);
@property (nonatomic,strong) NSDateComponents *dateComponents;
@property (nonatomic,assign) PGDatePickLabelStyle labelStyle;
